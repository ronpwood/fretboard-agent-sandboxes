...
Out of scope: playing all 7 diatonic chords, arbitrary/custom progressions, a tempo or
instrument UI, per-chord solo/mute, and any change to the existing single-note,
single-chord, or single-triad Play buttons' current behavior.
